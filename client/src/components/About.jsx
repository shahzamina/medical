...
<div style={{ backgroundImage: 'url(/images/about.jpg)',
        ...
        <div className="absolute inset-0 bg-gradient-to-tr from-[#001A4D]/90 via-[#0046A0]/70 to-[#0046A0]/40 z-10 flex flex-col items-left justify-center">
          <h1 className="text-white text-left sm:!text-sm lg:!text-6xl font-bold px-5 mt-5 ">   EXPLORE INFINITY GLOBAL </h1>
          <p  className="mt-4  text-white text-left  lg:px-12 lg:text-xl font-normal ">Leading Supplier of Radiology Equipment Parts</p>
          ...
          <p className='px-20 text-xl text-gray-600 mt-5'>We are Infinity Global, deeply committed to empowering the healthcare sector worldwide. As a trusted supplier, we deliver top-tier, high-quality parts for all major radiology modalities—MRI, CT Scan, X-ray, Ultrasound, Mammography, Angiography, Fluoroscopy, DR & CR Systems.
