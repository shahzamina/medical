...
import CreatableSelect from "react-select/creatable";
 ...
 const part = [
          ...
          {img:'/images/mamo51.jpg', p:'5233827-8-004 - GE Healthcare - Mammography  - Programmed CPU Board', link:'mamopro'},
...
const modalities = useMemo(() => {
  ...
  return (
    ...
    <>
  <div className='  bg-gradient-to-br from-gray-700/70 via-gray-500/50 to-gray-300/30 h-24'>
      ...
      />
        ...
        <input
          ...
          placeholder="Phone Number"
            className="bg-white border-2 border-[#0046A0] rounded-lg p-3 w-64 focus:border-[#1E90FF] outline-none placeholder:text-[#0046A0]"
        />
  ...
  render={({ field }) => {
    ...
    return (
      <CreatableSelect
        ...
        value={
          selectedOption
            ? { value: selectedOption.p, label: selectedOption.p }
            : null
        }
        onChange={(option) => {
